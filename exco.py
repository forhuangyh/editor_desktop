...
def main():
    ...
    from xc_gui.update_install_manager import UpdateInstallManager
    update_install_manager = UpdateInstallManager(login_window)
    update_install_manager.check_for_updates_and_prompt()

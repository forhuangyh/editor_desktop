...
def get(theme_name):
    ...
    file_path = functions.unixify_join(__get_theme_directory(), file_name)
...
def __check_color_list(field, color_list, prior_keys):
    try:
        ...
        print("[Themes] Color list error: {}!".format("->".join(prior_keys + (field,))))
        raise ex
...
def __check(theme_data):
    ...
    schema = {
        ...
        "foldmargin": {"background": __check_color, "foreground": __check_color},
        "fonts": {
            "array": {
                "color": __check_color,
                "bold": __check_bool,
        ...
        "linemargin": {"background": __check_color, "foreground": __check_color},
        "name": __check_string,
